...
do
	...
	curl -L -s "https://github.com/manami-project/anime-offline-database/releases/download/latest/anime-offline-database.jsonl" > "$SCRIPT_FOLDER/tmp/anime-offline-database.json"
